                                    ...
                                    <div class="relative">
                                        ...
                                        <div class="absolute top-4 right-4">
                                            <button wire:click="togglePackageStatus({{ $package->id }})" 
                                                    class="bg-{{ $package->is_active ? 'green' : 'red' }}-500 hover:bg-{{ $package->is_active ? 'green' : 'red' }}-600 text-white px-3 py-1 rounded-full text-xs font-bold shadow-lg transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-{{ $package->is_active ? 'green' : 'red' }}-500">
                ...
                <div class="p-8">
                    ...
                    <div class="mb-8 flex flex-col sm:flex-row justify-between items-center gap-4">
                        <div class="relative w-full sm:w-96">
                            ...
                            <input wire:model.live.debounce.300ms="searchUsers" type="text" 
                        ...
                        <div class="flex items-center space-x-2">
                            <select wire:model.live="filterUserType" class="rounded-xl border-gray-300 text-sm focus:ring-blue-500 focus:border-blue-500 shadow-sm">
                                                    ...
                                                    <div class="flex items-center">
                                                        <div class="flex-shrink-0 h-10 w-10">
                                                            <img class="h-10 w-10 rounded-full" 
                                                                 src="https://ui-avatars.com/api/?name={{ urlencode($user->name) }}&color=fff&background=4f46e5&size=128" 
                                                                 alt="{{ $user->name }}">
                                                        </div>
                                                        <div class="ml-4">
                    ...
                    @else
                        <div class="text-center py-16">
                            <div class="bg-gradient-to-br from-blue-100 to-blue-200 rounded-3xl p-12 max-w-md mx-auto">
                                ...
                                <h3 class="text-2xl font-bold text-blue-600 mb-2">No Users Found</h3>
                                <p class="text-blue-500 mb-6">There are no users matching your search criteria.</p>
                    ...
                    <div class="text-center py-20">
                        <div class="bg-gradient-to-br from-green-100 to-green-200 rounded-3xl p-12 max-w-md mx-auto">
                            ...
                            <div class="grid grid-cols-2 gap-4 text-sm">
                                ...
                                <div class="bg-white/60 rounded-xl p-4">
                                    <div class="text-2xl font-bold text-blue-600">${{ number_format(\App\Models\Order::sum('total_amount') ?? 0, 0) }}</div>
